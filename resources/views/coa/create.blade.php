...
<div class="card shadow mb-4 border-bottom-dark">
    <div class="card-header bg-gradient-dark py-3">
        <h6 class="m-0 font-weight-bold text-light">Create New Chart Of Account</h6>
    </div>
    <div class="card-body col-lg-8">
        <form action="/coa" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error ('code') is-invalid @enderror" id="code" name="code" placeholder="Enter code code.." required autofocus value="{{ old('code') }}">
                @error('code')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error ('name') is-invalid @enderror" id="name" name="name" placeholder="Enter coa name.." required autofocus value="{{ old('name') }}">
                @error('name')
                <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <button type="submit" class="btn btn-outline-success btn-icon-split">    
                ...
                <span class="text">Create Chart Of Account</span>
            </button>
          </form>
    </div>
</div>
